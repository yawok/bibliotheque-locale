...
class BookModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        book = Book.objects.create(title="Cell", author=author, summary="See ee el el, Cell", isbn='123sdf123asd7', language=language)
...
class BookInstanceModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        id2 = BookInstance.objects.create(book=book, imprint='Disney', status='o', due_back=(datetime.date.today() - datetime.timedelta(weeks=3))).id
        id3 = BookInstance.objects.create(book=book, imprint='Disney', status='o', due_back=(datetime.date.today() - datetime.timedelta(days=4))).id
