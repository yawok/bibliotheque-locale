...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=255, help_text="Enter a book genre.(Eg: Science Fiction)"
    )
...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(
        primary_key=True,
        default=uuid.uuid4,
        help_text="Unique ID of this book for the whole library.",
    )
    ...
    @admin.display(boolean=True, ordering="due_back", description="Over Due?")
    def is_overdue(self):
...
class Author(models.Model):
    ...
    date_of_death = models.DateField(
        "died", null=True, blank=True, help_text="YYYY-MM-DD"
    )
...
class Language(models.Model):
    ...
    name = models.CharField(
        max_length=255,
        help_text="Enter the book's natural language(Eg: English, French",
    )
